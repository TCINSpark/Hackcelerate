...
class KinematicBicycleModel():
    ...
    def kinematic_model(self, x, y, yaw, v, throttle, delta,y_ddot):
        ...
        y_ddot= (v * np.cos(yaw)*omega) + ((throttle - f_load) * np.sin(yaw))
        #x_ddot= -(v * np.sin(yaw)*omega) + ((throttle - f_load)* np.cos(yaw))
        ...
        return x, y, yaw, v, delta, omega, y_ddot
